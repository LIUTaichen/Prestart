package com.dempseywood.prestart;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String CLIENT_ID = "e338cc0a-1605-46ee-9f61-8c1af9f91ffe";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startPrestartButton = (Button) findViewById(R.id.startPrestart);
        signOutButton = (Button) findViewById(R.id.clearCache);
        signInButton = (Button) findViewById(R.id.signIn);
        welcomeText = (TextView) findViewById(R.id.welcome);

        startPrestartButton.setOnClickListener(new View.OnClickListener() {
    ...
    private void updateSuccessUI() {
        ...
        startPrestartButton.setVisibility(View.VISIBLE);
    ...
    private void updateSignedOutUI() {
        startPrestartButton.setVisibility(View.INVISIBLE);
        signOutButton.setVisibility(View.INVISIBLE);
        signInButton.setVisibility(View.VISIBLE);
        welcomeText.setVisibility(View.VISIBLE);
        welcomeText.setText(R.string.welcome_text_signed_out);
